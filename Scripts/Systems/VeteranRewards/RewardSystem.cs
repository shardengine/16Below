...
namespace Server.Engines.VeteranRewards
{
    ...
    {
		public static bool Enabled = Config.VetRewards.Enabled;
        public static bool SkillCapRewards = Config.VetRewards.SkillCapRewards;
        public static int SkillCap = Config.Player.SkillCap;
        public static int SkillCapBonus = Config.VetRewards.SkillCapBonus;
        public static int SkillCapBonusLevels = Config.VetRewards.SkillCapBonusLevels;
        public static float SkillCapBonusIncrement = SkillCapBonus / SkillCapBonusLevels;
        public static TimeSpan RewardInterval = Config.VetRewards.RewardInterval;
		public static int StartingLevel = Config.VetRewards.StartingLevel;
