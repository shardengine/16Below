...
namespace Server.Items
{
    ...
    {
        public static bool NewChestLocations = Config.TreasureMap.Randomized;
        public static double LootChance = Config.TreasureMap.LootChance;
        private static TimeSpan ResetTime = Config.TreasureMap.ResetTime;
