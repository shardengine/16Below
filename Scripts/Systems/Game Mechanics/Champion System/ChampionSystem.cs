...
namespace Server.Engines.CannedEvil
{
	public class ChampionSystem
	{
		...
		{
			m_Enabled = Config.Champions.Enabled;
			m_RotateDelay = Config.Champions.RotateDelay;
			m_GoldShowerPiles = Config.Champions.GoldPiles;
			m_GoldShowerMinAmount = Config.Champions.GoldMin;
			m_GoldShowerMaxAmount = Config.Champions.GoldMax;
			m_HarrowerGoldPiles = Config.Champions.HarrowerGoldPiles;
			m_HarrowerGoldMinAmount = Config.Champions.HarrowerGoldMin;
			m_HarrowerGoldMaxAmount = Config.Champions.HarrowerGoldMax;
			m_PowerScrollAmount = Config.Champions.PowerScrolls;
			m_StatScrollAmount = Config.Champions.StatScrolls;
			m_ScrollChance = Config.Champions.ScrollChance / 100.0d;
			m_TranscendenceChance = Config.Champions.TranscendenceChance / 100.0d;
			int rank2 = Config.Champions.Rank2RedSkulls;
			int rank3 = Config.Champions.Rank3RedSkulls;
			int rank4 = Config.Champions.Rank4RedSkulls;
			...
			m_MaxKill[0] = Config.Champions.Rank1MaxKills;
			m_MaxKill[1] = Config.Champions.Rank2MaxKills;
			m_MaxKill[2] = Config.Champions.Rank3MaxKills;
			m_MaxKill[3] = Config.Champions.Rank4MaxKills;
