...
namespace Server.Mobiles
{
	...
	{
		private static int MaxSell = Config.Vendors.MaxSell; // static was const
        ...
        public virtual TimeSpan RestockDelay { get { return Config.Vendors.RestockDelay; } }
