...
namespace Server.Misc
{
    public class CrashGuard
    {
        ...
        private static void SendEmail(string filePath)
        {
            ...
            message.Subject = "Automated 16Below Crash Report";

            message.Body = "Automated 16Below Crash Report. See attachment for details.";
        ...
        private static void GenerateCrashReport(CrashedEventArgs e)
        {
            ...
            try
            {
                ...
                using (StreamWriter op = new StreamWriter(filePath))
                {
                    ...
                    op.WriteLine("===================");
                    op.WriteLine();
                    op.WriteLine("16Below Version {0}.{1}, Build {2}.{3}", ver.Major, ver.Minor, ver.Build, ver.Revision);
