...
namespace Server.Misc
{
	public class ServerList
	{
        ...
        * are private network addresses and AutoDetect is 'true' then 16Below will attempt to discover your public IP address
        ...
        * a hostname that will be resolved when 16Below starts.
        * 
        ...
        */
		...
		public static string ServerName = Config.Server.ServerName;
		public static readonly bool AutoDetect = Config.Network.AutoDetect;
		public static readonly string Address = Config.Network.Address;
