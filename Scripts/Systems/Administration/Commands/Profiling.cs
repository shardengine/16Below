...
namespace Server.Commands
{
    public class Profiling
    {
        ...
        public static void CountObjects_OnCommand(CommandEventArgs e)
        {
            ...
            e.Mobile.SendMessage("Object table has been generated. See the file : <16Below root>/objects.log");
        }
        ...
        public static void ProfileWorld(string type, string opFile)
        {
            try
            {
                ...
                using (BinaryReader bin = new BinaryReader(new FileStream(String.Format("Bin/Saves/{0}/{0}.tdb", type), FileMode.Open, FileAccess.Read, FileShare.Read)))
                {
                ...
                using (BinaryReader bin = new BinaryReader(new FileStream(String.Format("Bin/Saves/{0}/{0}.idx", type), FileMode.Open, FileAccess.Read, FileShare.Read)))
                {
                    int count = bin.ReadInt32();
