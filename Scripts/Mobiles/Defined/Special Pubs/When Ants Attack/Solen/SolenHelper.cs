...
namespace Server.Mobiles
{
    public class SolenHelper
    {
        ...
        public static bool CheckRedFriendship(Mobile m)
        {
            ...
            return player != null; // && player.SolenFriendship == SolenFriendship.Red; update needed -Fraz
        }
        ...
        public static bool CheckBlackFriendship(Mobile m)
        {
            ...
            return player != null; // && player.SolenFriendship == SolenFriendship.Black; update needed -Fraz
        }
