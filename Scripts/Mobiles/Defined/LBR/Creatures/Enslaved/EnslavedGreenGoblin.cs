...
namespace Server.Mobiles
{
    ...
    public class EnslavedGreenGoblin : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.MagicResist, 121.6, 122.9);
            this.SetSkill(SkillName.Tactics, 80.0, 81.2);
            this.SetSkill(SkillName.Anatomy, 82.0, 83.4);
            this.SetSkill(SkillName.Wrestling, 99.2, 99.4);
