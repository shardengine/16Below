...
namespace Server.Mobiles
{
    ...
    public class BaseCreature : Mobile, IHonorTarget
    {
        ...
        */
        ...
        originally it taken out of 16Below, and not implmented on OSIs production shards until more 
		...
		*/
        ...
        /* To save on cpu usage, 16Below creatures only reacquire creatures under the following circumstances:
