...
namespace Server.Misc
{
    public class SkillCheck
    {
        ...
        public static TimeSpan AntiMacroExpire;

        public static void Configure()
        {
            AntiMacroCode = Config.Player.EnableAntiMacro;
            AntiMacroExpire = Config.Player.AntiMacroExpire;
            StatCap = Config.Player.StatCap;
            m_StatGainDelayEnabled = Config.Player.EnablePlayerStatTimeDelay;
            m_StatGainDelay = Config.Player.PlayerStatTimeDelay;
            m_PetStatGainDelayEnabled = Config.Player.EnablePetStatTimeDelay;
            m_PetStatGainDelay = Config.Player.PetStatTimeDelay;
            PlayerChanceToGainStats = Config.Player.PlayerChanceToGainStats;
            PetChanceToGainStats = Config.Player.PetChanceToGainStats;
