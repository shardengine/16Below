...
namespace Server.Misc
{
    ...
    {
        private static readonly TimeSpan    m_Delay         = Config.WorldSave.Delay;
        private static readonly TimeSpan    m_Warning       = Config.WorldSave.Warning;
        private static bool                 m_SavesEnabled  = Config.WorldSave.AutoSavesEnabled;
