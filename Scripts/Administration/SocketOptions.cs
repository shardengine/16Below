...
namespace Server
{
    ...
    {
        public static readonly int Port = Config.Network.Port;
        ...
        private static void EventSink_SocketConnect(SocketConnectEventArgs e)
        {
            ...
            if (!NagleEnabled)
                e.Socket.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.NoDelay, 1); // 16Below uses its own algorithm
        }
    }
}