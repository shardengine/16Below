	...
	public static class Assistants
	{
		...
		public class Settings
		{
			...
			static Settings()
			{
				...
				WarningMessage =
					"The server was unable to negotiate features with your assistant. You must download and run an updated version of <A HREF='http://www.16Below.com/products/assistuo'>AssistUO</A> or <A HREF='http://www.16Below.com/products/razor'>Razor</A>.<BR><BR>Make sure you've checked the option <B>Negotiate features with server</B>, once you have this box checked you may log in and play normally.<BR><BR>You will be disconnected shortly.";
			}
