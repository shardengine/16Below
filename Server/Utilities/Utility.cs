...
#pragma warning restore 618
        ...
        */
        ...
        {
            return !System.Text.RegularExpressions.Regex.IsMatch(str, "[^a-z]", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
        }

        public static bool IsAlphaNumeric(String str)
        {
            return !System.Text.RegularExpressions.Regex.IsMatch(str, "[^a-z0-9]", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
        }
        ...
        /* include later when needed -Fraz
