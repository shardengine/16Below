...
namespace Server
{
	...
	public class SkillInfo
	{
        ...
        private static SkillInfo[] m_Table = new SkillInfo[49]
        {
            ...
            new SkillInfo(  5, "Parrying",          7.5,    2.5,    0.0,    "Duelist",  null,   0.75,   0.25,   0.0,    1.0, StatCode.Int, StatCode.Str ),
	...
	public class Skills : IEnumerable<Skill>
	{
		...
		{
			m_Owner = owner;
            m_Cap = 7000; // set in PlayerMobile and basecreature by configs later -Fraz
